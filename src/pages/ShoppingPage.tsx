...
export function ShoppingPage(){
  ...
  const add=()=>{const name=newName.trim();if(!name){notify('请输入采购项目名称');return}setShopping([...data.shopping,{id:createId(),name,amount:1,unit:'份',status:'needed',custom:true}]);setNewName('');notify('已加入清单')}
