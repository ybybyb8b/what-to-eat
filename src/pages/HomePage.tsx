import { ArrowRight, Settings2, ShoppingBasket, Soup } from 'lucide-react'
...
export function HomePage() {
  ...
  return <div className="home-page">
    ...
    <aside className="home-note"><ShoppingBasket/><div><strong>今晚只做两人份</strong><span>采购数量和菜单都按两人份计算</span></div></aside>
  </div>
}
